...
export default class OTAQuestions extends React.Component {
    ...
    OpenQuestions() {
        ...
        if(this.state.data.content.ota_checklist && this.state.data.content.ota_checklist.length !== 0) {
            this.props.history.push({pathname: "/growth_check/ota/child/info", state: {data: this.state.data, childId: this.state.childId}})
        }
                    ...
                    <View style={{alignItems: "center", justifyContent: "center", marginTop: 15}}>
                        ...
                        <View style={{alignItems: "center", justifyContent: "center", marginTop: 30}}>
                           ...
                           {/*<div style={{marginTop: 30, borderWidth: 1, borderColor: "black", backgroundColor: "#FE017E", padding: 20, borderRadius: 10, width: 250}}>
                                <Link to={{pathname: "/growth_check/ota/start", state: {data: this.state.data, childId: this.state.childId}}} hash={"hash"} style={{borderWidth: 1, borderColor: "black", color: "white", fontSize: 20, fontWeight: "bold", textAlign: "center", marginLeft: 73}}>START OTA</Link>
                            </div>*/}
                        </View>
                    </View>
                }
