...
export default class GrowthCheckPro extends React.Component {
    ...
    render(){
        console.log("data in render of growth check pro is:", this.state.data)
        return(
            <View style={{flex: 1}}>
            {Platform.OS === "web" ?
                <View>
                    {this.state.data !== null ?
                        <View style={{alignItems: "center", justifyContent: "center", marginTop: 50}}>
                            <View style={{
                                ...
                                {Platform.OS === 'web' ?
                                    <ImageWeb defaultSource={require('../GCPRO.svg')}
                                              style={{width: 100, height: 100, marginLeft: 50}}/> :
                                    <Image source={require('../GCPRO.png')}
                                           style={{width: 100, height: 100, marginLeft: 50}}/>
                                }
                                <Text style={{
                                    alignItems: "center",
